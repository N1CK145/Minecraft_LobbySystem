  ...
  public boolean onCommand(CommandSender sender, Command arg1, String arg2, String[] args) {
    if (sender instanceof Player) {
      ...
      { if (p.hasPermission("lobby.cmd.spawn"))
        ...
        else { p.sendMessage(this.main.translateVars(this.main.getMessages().getString("error.no-permission"), p, "/spawn", "lobby.cmd.spawn")); }
         }
      else { p.sendMessage(this.main.translateVars(this.main.getMessages().getString("error.lobby-command-disabled"), p, "/spawn", "lobby.cmd.spawn")); }

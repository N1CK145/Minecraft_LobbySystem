  ...
  extends JavaPlugin
{
  ...
  private void mySQLSetup() {
    ...
    if (!API_MySQL.isConnected())
      return;  API_MySQL.update("CREATE TABLE IF NOT EXISTS lobby_lastOnline(UUID varchar(40) PRIMARY KEY NOT NULL,UserName varchar(30),value TIMESTAMP)ENGINE=InnoDB;");
